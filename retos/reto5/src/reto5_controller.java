...
public class reto5_controller {
    ...
    @FXML
    private TextField cantidad_habitantes_zona;
    ...
    void procesar(ActionEvent event) {
        if (Nombre.getText().equals("") || id_objeto.getText().equals("") || Municipio.getText().equals("") || tipo_agua.getText().equals("") || tipo_cuerpo.getText().equals("") || IRCA.getText().equals("") || cantidad_cuerpos_de_agua.getText().equals("") || cantidad_habitantes_zona.getText().equals("")) {
            ...
            texto += "\n" + DensidadPoblacional.afeccion(Integer.parseInt(cantidad_habitantes_zona.getText()));
